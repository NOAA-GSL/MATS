...
const doCurveParams = function () {
    ...
    if (matsCollections.CurveParams.find({name: 'statistic'}).count() == 0) {
        var optionsMap = {
            ...
            'PODy (POD of precip > threshold)': ['((sum(m0.yy)+0.00)/sum(m0.yy+m0.ny)) * 100 as stat, group_concat(((m0.yy)/(m0.yy+m0.ny)) * 100 order by m0.valid_time) as sub_values0 ,group_concat(m0.valid_time order by m0.valid_time) as sub_secs0, count(m0.yy) as N0', 'x100', 100],

            'PODn (POD of precip < threshold)': ['((sum(m0.nn)+0.00)/sum(m0.nn+m0.yn)) * 100 as stat, group_concat(((m0.nn)/(m0.nn+m0.yn)) * 100 order by m0.valid_time) as sub_values0 ,group_concat(m0.valid_time order by m0.valid_time) as sub_secs0, count(m0.yy) as N0', 'x100', 100],
            ...
            'Nlow (obs < threshold, avg per hr)': ['avg(m0.nn+m0.yn+0.000) as stat, group_concat((m0.nn+m0.yn) order by m0.valid_time) as sub_values0 ,group_concat(m0.valid_time order by m0.valid_time) as sub_secs0, count(m0.nn) as N0', 'Number', null],

            'Nhigh (obs > threshold, avg per hr)': ['avg(m0.yy+m0.ny+0.000) as stat, group_concat((m0.yy+m0.ny) order by m0.valid_time) as sub_values0 ,group_concat(m0.valid_time order by m0.valid_time) as sub_secs0, count(m0.yy) as N0', 'Number', null],
            ...
            'Ratio (Nlow / Ntot)': ['(sum(m0.nn+m0.yn+0.000)/sum(m0.yy+m0.yn+m0.ny+m0.nn+0.000)) as stat, group_concat(((m0.nn+m0.yn)/(m0.yy+m0.yn+m0.ny+m0.nn)) order by m0.valid_time) as sub_values0 ,group_concat(m0.valid_time order by m0.valid_time) as sub_secs0, count(m0.nn) as N0', 'Ratio', null],

            'Ratio (Nhigh / Ntot)': ['(sum(m0.yy+m0.ny+0.000)/sum(m0.yy+m0.yn+m0.ny+m0.nn+0.000)) as stat, group_concat(((m0.yy+m0.ny)/(m0.yy+m0.yn+m0.ny+m0.nn)) order by m0.valid_time) as sub_values0 ,group_concat(m0.valid_time order by m0.valid_time) as sub_secs0, count(m0.yy) as N0', 'Ratio', null],
