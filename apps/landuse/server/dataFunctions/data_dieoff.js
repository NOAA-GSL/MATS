  ...
  for (var curveIndex = 0; curveIndex < curvesLength; curveIndex++) {
    ...
    if (forecastLength === matsTypes.ForecastTypes.dieoff) {
      ...
      if (validTimes.length !== 0 && validTimes !== matsTypes.InputTypes.unused) {
        validTimeClause =
          'and floor((m0.valid_day+3600*m0.hour)%(24*3600)/3600) IN(' +
          validTimes +
          ')';
      }
      dateClause =
      ...
      if (utcCycleStart.length !== 0 && utcCycleStart !== matsTypes.InputTypes.unused) {
        utcCycleStartClause =
          'and floor((m0.valid_day+3600*m0.hour - m0.fcst_len*3600)%(24*3600)/3600) IN(' +
          utcCycleStart +
          ')';
      }
      dateClause =
        'and m0.valid_day+3600*m0.hour-m0.fcst_len*3600 >= ' +
        fromSecs +
        ' and m0.valid_day+3600*m0.hour-m0.fcst_len*3600 <= ' +
        toSecs;
    } else {
