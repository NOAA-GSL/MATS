...
Meteor.startup(function () {
    ...
    const mdr = new matsTypes.MetaDataDBRecord(matsTypes.DatabaseRoles.SUMS_DATA, "sumPool", "precip2", ['regions_per_model_mats_all_categories', 'threshold_descriptions', 'scale_descriptions', 'fcst_type_descriptions']);
    mdr.addRecord(matsTypes.DatabaseRoles.META_DATA, "metadataPool", "mats_common", ['region_descriptions']);
    try {
        matsMethods.resetApp({appMdr:mdr, appType:matsTypes.AppTypes.mats, app:'precipitationSub24hr', title: "Sub 24 Hour Precipitation", group: "Precipitation"});
    } catch (error) {
