...
Meteor.startup(function () {
    ...
    const mdr = new matsTypes.MetaDataDBRecord(matsTypes.DatabaseRoles.SUMS_DATA, "sumPool", "echotop", ['threshold_descriptions', 'regions_per_model_mats_all_categories']);
    mdr.addRecord(matsTypes.DatabaseRoles.META_DATA, "metadataPool", "mats_common", ['region_descriptions']);
    try {
        matsMethods.resetApp({appMdr: mdr, appType: matsTypes.AppTypes.mats, app: 'echotop', title: "Echo Top", group: "Radar"});
    } catch (error) {
