...
Meteor.startup(function () {
    ...
    try {
        matsMethods.resetApp({appPools: allPools, appMdr: mdr, appType: matsTypes.AppTypes.mats, app: 'precipitation24hr', title: "24 Hour Precipitation", group: "Precipitation"});
    } catch (error) {
