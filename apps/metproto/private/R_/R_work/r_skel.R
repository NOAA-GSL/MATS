...
#strPointsFile1 = "STRDATAFILE" + ".points1";
#strPointsFile2 = "STRDATAFILE" + ".points2";
...
listPlotCI[indexesNumSeries1], dblAlpha, boolVarianceInflationFactor, stat);
...
listPlotCI[indexesNumSeries2], dblAlpha, boolVarianceInflationFactor, stat);
...
for(index in 1:length(listPlotOrderSeries1Part)){
#newInd = (3 * listPlotOrderSeries1Part[index]) -2;
newInd = listPlotOrderSeries1Part[index];
listSeriesOrdered[newInd]=labels;
newInd = newInd + 1
#for(i in 0:2){
#listSeriesOrdered[newInd+i]=listSeries1[oldInd+i];
#}
listSeriesOrdered[newInd]=listSeries1[oldInd];
#cat(sprintf( "  oldInd = %d,  newInd = %d, length(listSeries1[oldInd]): %d\n", oldInd, newInd, length(listSeries1[oldInd]) ));
#oldInd = oldInd +3;
oldInd = oldInd +1;

#strPointsFile = sub("\\.data$", ".points1", strDataFile, perl=TRUE);
#write.table(listSeriesOrdered, file=strPointsFile1, quote=FALSE, row.names=FALSE, col.names=FALSE);
...
#strPointsFile = sub("\\.data$", ".points2", strDataFile, perl=TRUE);
#write.table(listSeriesOrdered, file=strPointsFile2, quote=FALSE, row.names=FALSE, col.names=FALSE);
print(listSeriesOrdered);
}
