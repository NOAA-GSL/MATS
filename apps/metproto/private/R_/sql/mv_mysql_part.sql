...
(
  ...
  INDEX(stat_header_id)
) ENGINE = MyISAM
  PARTITION BY LIST COLUMNS (model)(
       PARTITION GFS_212 VALUES IN ('GFS/212') ENGINE = MyISAM,
       PARTITION GFS_3 VALUES IN ('GFS/3') ENGINE = MyISAM,
       PARTITION GFS_216 VALUES IN ('GFS/216') ENGINE = MyISAM,
       PARTITION HRRR_255 VALUES IN ('HRRR/255') ENGINE = MyISAM,
       PARTITION NAM_212 VALUES IN ('NAM/212') ENGINE = MyISAM,
       PARTITION NAM_216 VALUES IN ('NAM/216') ENGINE = MyISAM,
       PARTITION NAM_218 VALUES IN ('NAM/218') ENGINE = MyISAM,
       PARTITION NAM_242 VALUES IN ('NAM/242') ENGINE = MyISAM,
       PARTITION NAM_243 VALUES IN ('NAM/243') ENGINE = MyISAM,
       PARTITION RAP_130 VALUES IN ('RAP/130') ENGINE = MyISAM,
       PARTITION RAP_236 VALUES IN ('RAP/236') ENGINE = MyISAM,
       PARTITION RAP_252 VALUES IN ('RAP/252') ENGINE = MyISAM,
       PARTITION RAP_242 VALUES IN ('RAP/242') ENGINE = MyISAM,
       PARTITION SRMEAN_212 VALUES IN ('SRMEAN/212') ENGINE = MyISAM,
       PARTITION SRMEAN_216 VALUES IN ('SRMEAN/216') ENGINE = MyISAM
       );
...
(
    ...
    ENGINE = MyISAM
    PARTITION BY RANGE(TO_DAYS(fcst_valid_beg))(
    PARTITION JULY_2014 VALUES LESS THAN (TO_DAYS('2014-08-01')) ENGINE = MyISAM,
    PARTITION AUG_2014 VALUES LESS THAN (TO_DAYS('2014-09-01')) ENGINE = MyISAM,
    PARTITION SEP_2014 VALUES LESS THAN (TO_DAYS('2014-10-01')) ENGINE = MyISAM,
    PARTITION OCT_2014 VALUES LESS THAN (TO_DAYS('2014-11-01')) ENGINE = MyISAM,
    PARTITION NOV_2014 VALUES LESS THAN (TO_DAYS('2014-12-01')) ENGINE = MyISAM,
    PARTITION DEC_2014 VALUES LESS THAN (TO_DAYS('2015-01-01')) ENGINE = MyISAM
    );
