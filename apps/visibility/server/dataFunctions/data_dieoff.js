    ...
    for (var curveIndex = 0; curveIndex < curvesLength; curveIndex++) {
        ...
        if (regionType === 'Predefined region') {
            ...
            statisticClause = "sum(if((m0.vis100 < {{threshold}}) and (o.vis100 < {{threshold}}),1,0)) as hit, sum(if((m0.vis100 < {{threshold}}) and NOT (o.vis100 < {{threshold}}),1,0)) as fa, " +
                ...
                "group_concat(if((m0.vis100 < {{threshold}}) and (o.vis100 < {{threshold}}),1,0), ';', if((m0.vis100 < {{threshold}}) and NOT (o.vis100 < {{threshold}}),1,0), ';', " +
                "if(NOT (m0.vis100 < {{threshold}}) and (o.vis100 < {{threshold}}),1,0), ';', if(NOT (m0.vis100 < {{threshold}}) and NOT (o.vis100 < {{threshold}}),1,0), ';', " +
