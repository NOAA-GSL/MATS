...
Meteor.startup(function () {
    ...
    try {
        matsMethods.resetApp({appPools: allPools, appCurveParams: appCurveParams, appMdr: mdr, appType: matsTypes.AppTypes.mats, app: 'visibility', title: "Visibility", group: "Ceiling and Visibility"});
    } catch (error) {
