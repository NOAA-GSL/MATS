...
const doCurveParams = function () {
    ...
    try {
        const rows = matsDataQueryUtils.simplePoolQueryWrapSynchronous(sumPool, "select model,regions,display_text,fcst_lens,trsh,truth,mindate,maxdate from regions_per_model_mats_all_categories order by display_category, display_order;");
...
const doCurveTextPatterns = function () {
    ...
    if (matsCollections.CurveTextPatterns.find().count() == 0) {
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "data-source", "region-type", "region", "statistic", "threshold", "average", "forecast-length", "valid-time", "truth", "sites", "sitesMap"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "data-source", "region-type", "region", "statistic", "threshold", "dieoff-type", "valid-time", "utc-cycle-start", "truth", "sites", "sitesMap", "curve-dates"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
        ...
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "data-source", "region-type", "region", "statistic", "threshold", "forecast-length", "truth", "sites", "sitesMap", "curve-dates"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "data-source", "region-type", "region", "statistic", "threshold", "utc-cycle-start", "truth", "sites", "sitesMap"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
        ...
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "data-source", "statistic", "threshold", "forecast-length", "valid-time", "truth", "sites", "sitesMap"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
...
Meteor.startup(function () {
    ...
    try {
        matsMethods.resetApp({appPools: allPools, appCurveParams: appCurveParams, appMdr: mdr, appType: matsTypes.AppTypes.mats, app: 'visibility15', title: "Visibility 15 Min", group: "Ceiling and Visibility"});
    } catch (error) {
