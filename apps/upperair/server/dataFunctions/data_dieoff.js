...
dataDieOff = function (plotParams, plotFunction) {
    ...
    for (var curveIndex = 0; curveIndex < curvesLength; curveIndex++) {
        ...
        if (diffFrom == null) {
            ...
            var finishMoment;
            try {
                queryResult = matsDataQueryUtils.queryDBSpecialtyCurve(sumPool, statement, 'dieOff', true);
                finishMoment = moment();
    ...
    if (curvesLength > 1 && (matching)) {
        dataset = matsDataMatchUtils.getSpecialtyCurveMatchedDataSetWithLevels(dataset, curvesLength, 'dieOff');
    }
