SELECT '1000.0' AS binVal,
       COUNT(DISTINCT m0.fcstValidEpoch) N_times,
       MIN(m0.fcstValidEpoch) min_secs,
       MAX(m0.fcstValidEpoch) max_secs,
       ((SUM(m0.data.['1000.0'].hits))/SUM(m0.data.['1000.0'].hits+m0.data.['1000.0'].misses)) AS pod,
       ((SUM(m0.data.['1000.0'].false_alarms))/SUM(m0.data.['1000.0'].false_alarms+m0.data.['1000.0'].hits)) AS far,
       SUM(m0.data.['1000.0'].hits+m0.data.['1000.0'].misses) AS oy_all,
       SUM(m0.data.['1000.0'].false_alarms+m0.data.['1000.0'].correct_negatives) AS on_all,
...
WHERE m0.type='DD'
    ...
    AND m0.fcstValidEpoch%(24*3600)/3600 IN[2,3,5]
    AND m0.fcstLen = 6
GROUP BY '1000.0'
ORDER BY binVal;