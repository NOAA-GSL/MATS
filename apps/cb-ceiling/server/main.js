    ...
    try {
        for (didx = 0; didx < dbs.length; didx++) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                forecastLengthOptionsMap[dbs[didx]][model] = rows[i].fcstLens.map(String);
                ...
                for (var t = 0; t < rows[i].thresholds.length; t++) {
                    thresholdArr.push(masterThresholdValuesMap[dbs[didx]][rows[i].thresholds[t]]);
                }
                thresholdsModelOptionsMap[dbs[didx]][model] = thresholdArr;
