...
var require = meteorInstall({"node_modules":{"meteor":{"yasinuslu:json-view":{"jquery.jsonview.js":function(require,exports,module){

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                            //
// packages/yasinuslu_json-view/jquery.jsonview.js                                                            //
//                                                                                                            //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                              //
/*!
...
},"template.json-view.js":function(){

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                            //
// packages/yasinuslu_json-view/template.json-view.js                                                         //
//                                                                                                            //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                              //

Template.__checkName("jsonView");
Template["jsonView"] = new Template("Template.jsonView", (function() {
  var view = this;
  return HTML.Raw('<div class="json-view"></div>');
}));

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"json-view.js":function(){

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                            //
// packages/yasinuslu_json-view/json-view.js                                                                  //
//                                                                                                            //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                              //
...
Template.jsonView.onRendered(function () {
  ...
  this.autorun(function () {
    var json = _this.view.lookup('json')();

    var options = _this.view.lookup('options')();

    _this.$('.json-view').JSONView(json || {}, options || {});
  });
});
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
require("/node_modules/meteor/yasinuslu:json-view/jquery.jsonview.js");
require("/node_modules/meteor/yasinuslu:json-view/template.json-view.js");
require("/node_modules/meteor/yasinuslu:json-view/json-view.js");

/* Exports */
Package._define("yasinuslu:json-view");
