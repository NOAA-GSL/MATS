...
var s=$(_267).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layouts:visible,.easyui-fluid:visible").filter(function(_269,el){
...
opts.onAdd=_3b7;
cc.append("<div class=\"layouts-split-proxy-h\"></div><div class=\"layouts-split-proxy-v\"></div>");
...
var _3bf="layouts-button-"+_3be[dir];
...
}},_3bb,{cls:((_3bb.cls||"")+" layouts-panel layouts-panel-"+dir),bodyCls:((_3bb.bodyCls||"")+" layouts-body")});
pp.panel(_3bd);
_3bc[dir]=pp;
var _3c0={north:"s",south:"n",east:"w",west:"e"};
var _3c1=pp.panel("panel");
if(pp.panel("options").split){
_3c1.addClass("layouts-split-"+dir);
}
_3c1.resizable($.extend({},{handles:(_3c0[dir]||""),disabled:(!pp.panel("options").split),onStartResize:function(e){
_3a9=true;
if(dir=="north"||dir=="south"){
var _3c2=$(">div.layouts-split-proxy-v",_3ba);
}else{
var _3c2=$(">div.layouts-split-proxy-h",_3ba);
}
...
_3c2.css(pos);
$("<div class=\"layouts-mask\"></div>").css({left:0,top:0,width:cc.width(),height:cc.height()}).appendTo(cc);
},onResize:function(e){
if(dir=="north"||dir=="south"){
var _3c5=$(">div.layouts-split-proxy-v",_3ba);
_3c5.css("top",e.pageY-$(_3ba).offset().top-_3c5.height()/2);
}else{
var _3c5=$(">div.layouts-split-proxy-h",_3ba);
_3c5.css("left",e.pageX-$(_3ba).offset().left-_3c5.width()/2);
}
return false;
},onStopResize:function(e){
cc.children("div.layouts-split-proxy-v,div.layouts-split-proxy-h").hide();
pp.panel("resize",e.data);
_3aa(_3ba);
_3a9=false;
cc.find(">div.layouts-mask").remove();
}},_3bb));
...
var icon="layouts-button-"+_3d6[dir];
var p=$("<div></div>").appendTo(_3cc);
p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("layouts-expand layouts-expand-"+dir),title:"&nbsp;",iconCls:(_3d0.hideCollapsedContent?null:_3d0.iconCls),closed:true,minWidth:0,minHeight:0,doSize:false,region:_3d0.region,collapsedSize:_3d0.collapsedSize,noheader:(!isns&&_3d0.hideExpandTool),tools:((isns&&_3d0.hideExpandTool)?null:[{iconCls:icon,handler:function(){
_3dd(_3cc,_3cd);
return false;
}}])}));
...
$(this).addClass("layouts-expand-over");
},function(){
$(this).removeClass("layouts-expand-over");
});
return p;
};
function _3d4(){
...
cc.push("<div class=\"panel-title layouts-expand-title");
cc.push(opts.iconCls?" layouts-expand-with-icon":"");
