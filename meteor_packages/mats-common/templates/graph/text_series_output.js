...
Template.textSeriesOutput.helpers({
    ...
    stats: function(curve) {
        ...
        const line = "<td>" + curve.label + "</td>" +
            "<td>" + stats.d_mean ? stats.d_mean.toPrecision(4) : "" + "</td>" +
            "<td> +/- " + stats.stde_betsy ? stats.stde_betsy.toPrecision(4) : "" + "</td>" +
            "<td>" + stats.n_good + "</td>" +
            "<td>" + stats.sd ? stats.sd.toPrecision(4) : "" + "</td>" +
            "<td>" + stats.lag1 ? stats.lag1.toPrecision(4) : "" + "</td>" +
            "<td>" + stats.minVal ? stats.minVal.toPrecision(4) : "" + "</td>" +
            "<td>" + stats.maxVal ? stats.maxVal.toPrecision(4) : "" + "</td>";
        return line;
    }
});
