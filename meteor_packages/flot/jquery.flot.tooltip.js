...
(function ($) {
	...
	var nPiePattern = "%n";
	    ...
	    //RTP - use the last item.series.data element for the customText instead of the third item.datapoint.
            // Other custom stuff might go in third item.datapoint
            customText = item.series.data[item.dataIndex][item.series.data[item.dataIndex].length -1]; 
	}
