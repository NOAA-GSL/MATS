...
echo "rancher app install matshome matshome -n $ns --set defaultImage=true --set persistentVolumeClaim=${pvc} --set rootUrl=${rootUrl} --set defaultCredentials=${defaultCredentials}"
rancher app install matshome matshome -n $ns --set defaultImage=true --set persistentVolumeClaim=${pvc} --set rootUrl=${rootUrl} --set defaultCredentials=${defaultCredentials}
