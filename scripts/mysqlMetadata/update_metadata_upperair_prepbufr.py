...
#
# Updates the regions_per_model_mats_all_categories table for all models in ruc_ua_pb and ruc_ua_pb_sums2
...
def reprocess_specific_metadata(models_to_reprocess):
    ...
    for model in models_to_reprocess:
        ...
        if model in main_model_keys and main_models[model] in main_model_order_keys:
            ...
            get_display_params = "select display_category,display_order from " + db1 + \
