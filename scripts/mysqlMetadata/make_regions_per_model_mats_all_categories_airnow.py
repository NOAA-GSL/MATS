#!/usr/bin/env python
#
# Creates a regions_per_model_mats_all_categories table for all models in airnow and airnow_sums
...
def regions_per_model_mats_all_categories(mode):
    ...
    skiptables = " obs2p5 retro_obs2p5 scale_descriptions stations tables_to_backup threshold_descriptions "
