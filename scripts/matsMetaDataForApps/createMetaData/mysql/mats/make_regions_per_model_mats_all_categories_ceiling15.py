#!/usr/bin/env python
#
# Creates a regions_per_model_mats_all_categories table for all models in ceiling_15 and ceiling_15_sums
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == 'deploy':
            ...
            msg = 'CEILING_15 MATS METADATA START: ' + utcnow
            print(msg)
            regions_per_model_mats_all_categories('deploy')
            utcnow = str(datetime.now())
            msg = 'CEILING_15 MATS METADATA END: ' + utcnow
            print(msg)
