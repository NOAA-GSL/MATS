#!/usr/bin/env python
#
# Creates a regions_per_model_mats_all_categories table for all models in ensemble_pqpf
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == 'deploy':
            ...
            msg = 'ENSEMBLE PQPF MATS METADATA START: ' + utcnow
            print(msg)
            regions_per_model_mats_all_categories('deploy')
            utcnow = str(datetime.now())
            msg = 'ENSEMBLE PQPF MATS METADATA END: ' + utcnow
            print(msg)
