#!/usr/bin/env python
#
# Creates a regions_per_model_mats_all_categories table for all models in pb_amdar
...
def regions_per_model_mats_all_categories(mode):
    ...
    skiptables = " regions_per_model_mats_all_categories regions_per_model_mats_all_categories_build template TABLESTATS_build 7day acars limits tail "
