#!/usr/bin/env python
#
# Creates a regions_per_model_mats_all_categories table for all models in cloud_base and cloud_base_sums
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == 'deploy':
            ...
            msg = 'CLOUD BASE MATS METADATA START: ' + utcnow
            print(msg)
            regions_per_model_mats_all_categories('deploy')
            utcnow = str(datetime.now())
            msg = 'CLOUD BASE MATS METADATA END: ' + utcnow
            print(msg)
