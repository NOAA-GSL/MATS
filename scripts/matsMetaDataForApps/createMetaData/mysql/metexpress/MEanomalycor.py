...
class MEAnomalycor:
    ...
    def get_options(self, args):
        ...
        MEAnomalycor.validate_options(options)
        return options


if __name__ == '__main__':
    print('Anomalycor MATS FOR MET METADATA START: ' + str(datetime.now()))
    ...
    me_dbcreator.line_data_table = "line_data_sal1l2"
    me_dbcreator.metadata_table = "anomalycor_mats_metadata"
    ...
    me_dbcreator.database_groups = "anomalycor_database_groups"
    ...
    print('Anomalycor MATS FOR MET METADATA END: ' + str(datetime.now()))
    sys.exit(0)
