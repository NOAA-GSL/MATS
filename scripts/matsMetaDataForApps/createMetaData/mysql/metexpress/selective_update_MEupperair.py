    ...
    def build_stats_object(self):
        ...
        for mvdb in mvdbs:
            ...
            for model in mvdb_map[mvdb]:
                ...
                print("selective_MEupperair air - Getting stats for model " + model)
                num_recs = 0
                min = datetime.max
...
if __name__ == '__main__':
    ...
    updater = UpdateMEUpperair(options['cnf_file'], options['metadata_database'])  # constructor needs cnf_file
