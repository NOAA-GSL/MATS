...
class MESurface:
    def __init__(self):
        ...
        self.metadata_table = "surface_mats_metadata"
        self.app_reference = "met-surface"
        self.string_fields = ["regions", "levels", "fcst_lens", "variables", "fcst_orig"]
        self.int_fields = ["mindate", "maxdate", "numrecs", "updated"]
        self.database_groups = "surface_database_groups"
    ...
    def mysql_prep_tables(self):
        ...
        if self.cursor.rowcount == 0:
            ...
            create_table_query = 'create table {}_dev (db varchar(255), model varchar(255), display_text varchar(255), regions varchar(2047), levels varchar(2047), fcst_lens varchar(4095), variables varchar(2047), fcst_orig varchar(4095), mindate int(11), maxdate int(11), numrecs int(11), updated int(11));'.format(
                self.metadata_table)
