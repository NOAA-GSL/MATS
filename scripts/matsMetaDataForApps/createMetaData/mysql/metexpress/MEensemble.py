    ...
    def build_stats_object(self):
        ...
        for mvdb in mvdbs:
            ...
            for line in self.cursor:
                ...
                get_stats_earliest = 'select min(fcst_valid_beg) as mindate, max(fcst_valid_beg) as max_date from (select fcst_valid_beg,stat_header_id from line_data_sl1l2 order by stat_header_id limit 10000) s where stat_header_id in (select stat_header_id from stat_header where model="' + model + '");'
