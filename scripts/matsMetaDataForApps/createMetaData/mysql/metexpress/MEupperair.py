...
class MEUpperair:
    def mysql_prep_tables(self):
        ...
        if self.cursor.rowcount == 0:
            ...
            create_table_query = 'create table upperair_mats_metadata_dev (db varchar(80), model varchar(80), display_text varchar(255), regions varchar(1023), levels varchar(1023), fcst_lens varchar(1023), variables varchar(1023), fcst_orig varchar(1023), mindate int(11), maxdate int(11), numrecs int(11), updated int(11));'
