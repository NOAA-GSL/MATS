...
export default (label) => {
  ...
  if (label === "Remove All") {
    ...
    $("#remove-all").waitForDisplayed();
    $("#remove-all").scrollIntoView();
    pause(intMs);
    $("#remove-all")[method]();
    ...
    $$("#confirm-remove-all")[1].waitForDisplayed();
    $$("#confirm-remove-all")[1].scrollIntoView();
    pause(intMs);
    ...
    $(`#curve-list-remove*=${cPart}`).scrollIntoView();
    pause(intMs);
