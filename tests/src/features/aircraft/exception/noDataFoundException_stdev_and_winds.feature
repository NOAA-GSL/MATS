Feature: No Data Found Exception: stdev_and_winds
    ...
    Scenario: noDataFoundException_stdev_and_winds
        ...
        And I should see "INFO:  The statistic/variable combination [Std deviation and winds] is not supported by the database for the model/region [RAP_iso and Full]." in the "info" dialog
