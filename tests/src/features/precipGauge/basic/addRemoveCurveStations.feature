Feature: Add Remove Curve
    ...
    Scenario: addRemoveCurve
        ...
        When I change the "sites" parameter to "BEAR LAKE CO US SNOTEL MesoWest (BLKC2)"
        Then the "sites" parameter value matches "BEAR LAKE CO US SNOTEL MesoWest (BLKC2)"
