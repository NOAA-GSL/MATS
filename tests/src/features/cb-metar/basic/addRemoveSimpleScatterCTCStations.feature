Feature: Add Remove Curve
    ...
    Scenario: addRemoveCurve
        ...
        When I change the "x-threshold" parameter to "60000 (ceiling <60000 ft -- any cloud)"
        Then the "x-threshold" parameter value matches "60000 (ceiling <60000 ft -- any cloud)"
