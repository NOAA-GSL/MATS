Feature: addThreeCurvesRemoveOneCurveAddAnotherCurve
    ...
    I want to change the data-source to HRRR_GSL_iso
    ...
    Scenario: addThreeCurvesRemoveOneCurveAddAnotherCurve
        ...
        When I set the dates to "12/15/2020 0:00 - 03/15/2021 0:00"
        Then the dates value is "12/15/2020 0:00 - 03/15/2021 0:00"
        ...
        When I change the "phase" parameter to "EnR"
        Then the "phase" parameter value matches "EnR"
        When I click the "Add Curve" button
