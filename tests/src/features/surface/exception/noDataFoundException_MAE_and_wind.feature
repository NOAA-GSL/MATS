Feature: No Data Found Exception: MAE_and_wind
    ...
    I want to change the variable to 10m wind
    ...
    Scenario: noDataFoundException_MAE_and_wind
        ...
        And I should see "INFO:  The statistic/variable combination [MAE and 10m wind] is not supported by the database for the model/region [RR1h and ALL_HRRR]." in the "info" dialog
