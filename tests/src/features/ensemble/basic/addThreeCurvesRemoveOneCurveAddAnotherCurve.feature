Feature: addThreeCurvesRemoveOneCurveAddAnotherCurve
    ...
    Scenario: addThreeCurvesRemoveOneCurveAddAnotherCurve
        ...
        When I change the "data-source" parameter to "RRFSE_MPTL"
        Then the "data-source" parameter value matches "RRFSE_MPTL"
        When I click the "Add Curve" button
        ...
        When I change the "data-source" parameter to "RRFSE_SPTL"
        Then the "data-source" parameter value matches "RRFSE_SPTL"
        When I click the "Add Curve" button
